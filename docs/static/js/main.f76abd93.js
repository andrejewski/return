/*! For license information please see main.f76abd93.js.LICENSE.txt */
!(function () {
  var e = {
      597: function (e, n, t) {
        'use strict'
        ...
        Object.defineProperty(n, '__esModule', { value: !0 }),
          (n.batchPrograms = n.batchEffects = n.mapEffect = void 0),
          (n.mapEffect = l),
          (n.batchEffects = o),
          (n.batchPrograms = function (e, n) {
            var t,
              i = [],
              u = [],
              s = a(e)
            try {
              for (s.s(); !(t = s.n()).done; ) {
                var c = t.value
                i.push(c.init[0]), u.push(c.init[1])
              }
            } catch (f) {
              s.e(f)
            } finally {
            ...
            return {
              init: [
                i,
                o(
                  u.flatMap(function (e, n) {
                    return e
                      ? [
                          l(e, function (e) {
                            return { index: n, data: e }
                          }),
                        ]
                      : []
                  })
              ...
              view: function (t, r) {
                var a = e.map(function (e, n) {
                  return function () {
                    return e.view(t[n], function (e) {
                      return r({ index: n, data: e })
                    })
                  }
                })
                return n(a)
      ...
      97: function (e, n, t) {
        ...
        function u(e, n) {
          var t,
            r = [].concat(l(Object.keys(e)), l(Object.keys(n))),
            u = {},
            s = [],
            c = {},
            f = a(r)
          ...
          return { effect: (0, o.batchEffects)(s), cancelMap: c }
        }
        n.Db = function (e) {
          var n = r(e.init, 2),
            t = n[0],
            a = n[1],
            l = u({}, e.subscriptions(t)),
            i = l.effect
          return {
            init: [
              { cancelMap: l.cancelMap, programModel: t },
              (0, o.batchEffects)([a, i]),
            ],
            update: function (n, t) {
              var a = e.update(n, t.programModel),
                l = r(a, 2),
                i = l[0],
                s = l[1],
                c = u(t.cancelMap, e.subscriptions(i)),
                f = c.effect
              return [
                { cancelMap: c.cancelMap, programModel: i },
                (0, o.batchEffects)([s, f]),
              ]
            },
            done: function (n) {
              u(n.cancelMap, {}).effect(function () {}),
                e.done && e.done(n.programModel)
            },
            view: function (n, t) {
              return e.view(n.programModel, t)
            },
          }
        }
      },
      463: function (e, n, t) {
        ...
        function Ae(e, n, t, r, a, l, o, i, u) {
          ;(je = !1), (Ie = null), De.apply(Ve, arguments)
        }
        function Be(e) {
          var n = e,
            t = e
        ...
        function Kn(e, n, t, r) {
          if (Hn) {
            var a = Xn(e, n, t, r)
            if (null === a) Wr(e, n, r, Yn, t), jn(e, r)
            else if (
              (function (e, n, t, r, a) {
                switch (n) {
                  case 'focusin':
        ...
        var Al = {
          ...
          enqueueSetState: function (e, n, t) {
            ...
            ;(l.payload = n),
              ...
              null !== (n = Rl(e, l, a)) && (ts(n, e, a, r), Dl(n, e, a))
          },
          ...
          enqueueForceUpdate: function (e, n) {
            ...
            ;(a.tag = 2),
              ...
              null !== (n = Rl(e, a, r)) && (ts(n, e, r, t), Dl(n, e, r))
          },
        }
        ...
        function Hl(e, n, t, r) {
          ...
          'object' === typeof l && null !== l
            ? (a.context = El(l))
            : ((l = Oa(n) ? Ta : za.current), (a.context = Ma(e, l))),
        ...
        function as(e, n) {
          if (((Zu = -1), (Ju = 0), 0 !== (6 & zu))) throw Error(l(327))
          var t = e.callbackNode
              ...
              switch (((e.finishedWork = a), (e.finishedLanes = r), n)) {
                ...
                case 3:
                  if (
                    ...
                    e.timeoutHandle = ra(ks.bind(null, e, Vu, $u), n)
                    break
                  }
                  ks(e, Vu, $u)
                  break
        ...
        function vs(e, n) {
          ...
          if ((kl(), (zu = t), (Eu.current = r), null !== Tu))
            throw Error(l(261))
          return (Nu = null), (Mu = 0), Ru
        }
        function gs() {
          for (; null !== Tu; ) bs(Tu)
        }
        ...
        function Es(e, n, t) {
          ...
          null !== r && r.delete(n),
            ...
            Nu === e &&
              (Mu & t) === t &&
              (4 === Ru ||
              (3 === Ru && (130023424 & Mu) === Mu && 500 > Ge() - Au)
                ? ds(e, 0)
                : (Fu |= t)),
            rs(e, n)
        }
        ...
        function Rs(e, n, t, r, a, o) {
          ...
          if (((r = e), 'function' === typeof e)) Os(e) && (i = 1)
            ...
            e: switch (e) {
              ...
              case E:
                return (
                  ((e = Ms(12, t, n, 2 | a)).elementType = E), (e.lanes = o), e
                )
              case N:
                return ((e = Ms(13, t, n, a)).elementType = N), (e.lanes = o), e
              case T:
                return ((e = Ms(19, t, n, a)).elementType = T), (e.lanes = o), e
              case L:
                return js(t, a, o, n)
              default:
        ...
        function Ws(e, n, t, r) {
          ...
          return (
            ...
            null !== (e = Rl(a, n, o)) && (ts(e, a, o, l), Dl(e, a, o)),
            o
          )
        }
        function Hs(e) {
          ...
          switch (((n.lanes = 0), n.tag)) {
            ...
            case 1:
              return (
                (r = n.type),
                (a = n.pendingProps),
                zi(e, n, r, (a = n.elementType === r ? a : vl(r, a)), t)
              )
            case 3:
              e: {
  ...
  !(function () {
    ...
    function m(e) {
      return d(e) || s(e) || c(e) || p()
    }
    var v = t(97),
      g = t(184)
    function y(e) {
      return {
        x: Math.floor(Math.random() * (e.width - 20)) + 10,
        y: Math.floor(Math.random() * (e.height - 20)) + 10,
      }
    }
    function b(e, n) {
    ...
    function w(e) {
      for (
        var n = [], t = 10 + Math.floor(6 * Math.random()), r = 0;
        r < t;
        r++
      )
        n.push(y(e))
      var a = (function (e) {
          ...
          for (var n = [], t = 0; t < e.length; t++) {
            for (var r = e[t]; n.length >= 2; ) {
              var a = n[n.length - 1],
                l = n[n.length - 2]
              if (!((a.x - l.x) * (r.y - l.y) >= (a.y - l.y) * (r.x - l.x)))
                break
              n.pop()
            }
            n.push(r)
          ...
          for (var o = [], i = e.length - 1; i >= 0; i--) {
            for (var u = e[i]; o.length >= 2; ) {
              var s = o[o.length - 1],
                c = o[o.length - 2]
              if (!((s.x - c.x) * (u.y - c.y) >= (s.y - c.y) * (u.x - c.x)))
                break
              o.pop()
            }
            o.push(u)
        ...
        l = { width: e.width / 4, height: e.height / 4 },
        o = [y(l), y(l)]
          .map(function (e, n) {
            return {
              x: e.x + l.width * (0 === n ? 0.75 : 1.25),
              y: e.y + l.height * (0 === n ? 0.75 : 1.25),
            }
          })
          .sort(b),
        i = h(o, 2),
        u = i[0],
        s = i[1],
        c = Math.floor(Math.random() * (a.length / 2)),
        f = Math.floor(Math.random() * (a.length / 2) + a.length / 2)
      a.splice(c, 0, u), a.splice(f, 0, s)
      var d = a,
        p = (function (e) {
          for (
            var n = [], t = m(e), r = t[0], a = t.slice(1), l = 0;
            l < e.length;
            l++
          )
            n.push([e[l], a[l]])
          return (n[e.length - 1][1] = r), n
        })(d)
      if (
        p.some(function (e) {
          return p.some(function (n) {
            return (function (e, n, t, r, a, l, o, i) {
              var u, s, c
              return (
                (u = (t - e) * (i - l) - (o - a) * (r - n)),
                0 !== u &&
                  ((s = ((n - r) * (o - e) + (t - e) * (i - n)) / u),
                  0 < (c = ((i - l) * (o - e) + (a - o) * (i - n)) / u) &&
                    c < 1 &&
                    0 < s &&
                    s < 1)
              )
            })(e[0].x, e[0].y, e[1].x, e[1].y, n[0].x, n[0].y, n[1].x, n[1].y)
          })
        })
      )
        return w(e)
      var v = Math.min(e.width, e.height) / 10
    ...
    function S(e) {
      ...
      return n > 1e3 ? 20 : n > 500 ? 15 : 10
    }
    function x(e, n, t, r, a, l) {
      l && e.clearRect(0, 0, n.width, n.height)
      var o = m(t.points),
        i = o[0],
        u = o.slice(1),
        s = [i].concat(f(u), [i])
      ...
      for (var c = 0; c < s.length; c++) {
        var d = s[c + 1] || i,
          p = (s[c].x + d.x) / 2,
          h = (s[c].y + d.y) / 2
        e.quadraticCurveTo(s[c].x, s[c].y, p, h)
      }
      e.stroke(), a && e.fill()
    }
    function _(e, n) {
      if (
        ...
        return (
          e.beginPath(),
          e.arc(t.x, t.y, e.lineWidth / 2, 0, 2 * Math.PI, !0),
          e.closePath(),
          void e.fill()
        )
      }
      e.beginPath(), e.moveTo(n[0].x, n[0].y)
      for (var r = 1; r < n.length - 2; r++) {
        var a = (n[r].x + n[r + 1].x) / 2,
          l = (n[r].y + n[r + 1].y) / 2
        e.quadraticCurveTo(n[r].x, n[r].y, a, l)
      }
      e.quadraticCurveTo(n[r].x, n[r].y, n[r + 1].x, n[r + 1].y), e.stroke()
    }
    var E = (0, v.Db)({
      init: [
        {
          ...
          foregroundCanvasElement: void 0,
          backgroundCanvasElement: void 0,
          offscreenCanvasElement: document.createElement('canvas'),
          foregroundCtx: void 0,
          backgroundCtx: void 0,
          gameStart: 0,
          gameLength: 0,
          pixelsFilled: 0,
          pixelsOverfilled: 0,
        ...
        switch (e.type) {
          case 'start_game':
            ...
            return [
              t,
              function () {
                var e = n.backgroundCtx,
                  r = n.canvasViewSize
                e && r && e.clearRect(0, 0, r.width, r.height),
                  x(
                    t.foregroundCtx,
                    t.canvasViewSize,
                    t.shape,
          ...
          case 'end_game':
            var r = Date.now() - n.gameStart,
              a = n.offscreenCanvasElement,
              l = n.backgroundCanvasElement,
              o = n.backgroundCtx,
              u = n.foregroundCanvasElement
            ;(a.width = l.width), (a.height = l.height)
            var s = a.getContext('2d')
            s.clearRect(0, 0, n.canvasViewSize.width, n.canvasViewSize.height),
              s.drawImage(
                l,
                0,
                0,
                n.canvasViewSize.width,
                n.canvasViewSize.height,
                0,
                0,
                n.canvasViewSize.width,
                n.canvasViewSize.height
              ),
              x(s, n.canvasViewSize, n.shape, '#000', !0, !1)
            for (
              var c = s.getImageData(
                  0,
                  0,
                  n.canvasViewSize.width,
                  n.canvasViewSize.height
              ...
              170 === c[d] && f++
            s.clearRect(0, 0, n.canvasViewSize.width, n.canvasViewSize.height),
              x(s, n.canvasViewSize, n.shape, '#fff', !0, !1)
            for (
              var p = o.getImageData(
                  0,
                  0,
                  n.canvasViewSize.width,
                  n.canvasViewSize.height
              ...
              255 === h[g] && (170 === p[g] ? m++ : v++)
            ;(s.fillStyle = '#fff'),
              s.fillRect(0, 0, n.canvasViewSize.width, n.canvasViewSize.height),
              s.drawImage(
                l,
                0,
                0,
            ...
            var y = ''.concat(((100 * m - 5 * f) / (m + v)).toFixed(2), '%'),
              b = Math.floor(r / 1e3),
              E = 'Re:Turn',
              C = 'Colored '.concat(y, ' in ').concat(b, ' seconds')
            ;(s.fillStyle = '#000'),
              (s.font =
            ...
            var P = s.measureText(E),
              z = 10 * window.devicePixelRatio
            s.fillText(
              E,
              z,
              n.canvasViewSize.height -
                z -
                P.fontBoundingBoxDescent * window.devicePixelRatio
            )
            var N = s.measureText(C)
            s.fillText(
              C,
              n.canvasViewSize.width - z - N.width,
              n.canvasViewSize.height -
                z -
                N.fontBoundingBoxDescent * window.devicePixelRatio
            )
            var T = a.toDataURL()
            return [
              i(
          ...
          case 'open_score_explainer':
            return [
              i(i({}, n), {}, { scoreExplainerOpen: 'game-over' === n.page }),
            ]
          case 'dismiss_score_explainer':
            return [i(i({}, n), {}, { scoreExplainerOpen: !1 })]
          case 'window_resize':
            if ('game' === n.page) return [n]
            var M = e.width,
              O = e.height,
              L = { width: M, height: O },
              R = M - 40,
              ...
              j =
                M > O
                  ? { width: R, height: Math.min(D, Math.floor(R / 1.5)) }
                  : { height: D, width: Math.min(R, Math.floor(D / 1.5)) },
              I = {
                width: j.width * window.devicePixelRatio,
                height: j.height * window.devicePixelRatio,
              },
              F = { width: I.width, height: I.height - 60 },
              U = n.shape.points.length ? n.shape : w(F)
            return [
              i(
                i({}, n),
                {},
          ...
          case 'canvas_mounted':
            ...
            switch (e.kind) {
              case 'foreground':
                V = { foregroundCanvasElement: A, foregroundCtx: B }
                break
              case 'background':
                V = { backgroundCanvasElement: A, backgroundCtx: B }
            }
            return [i(i({}, n), V)]
          case 'canvas_render':
            n.foregroundCtx
            return [n]
          case 'canvas_draw':
            var $ = n.backgroundCanvasElement.getBoundingClientRect(),
              W = {
                x: (e.windowX - $.left) * window.devicePixelRatio,
                y: (e.windowY - $.top) * window.devicePixelRatio,
              },
              H = n.drawPointBuffer
            if (H.length < 5) return H.push(W), [n]
            var Q = n.backgroundCtx
            return Q
              ? [
                  i(i({}, n), {}, { drawPointBuffer: [W] }),
                  function () {
                    ;(Q.lineWidth = 2 * S(n.canvasViewSize)), _(Q, H.concat(W))
                  },
                ]
              : [n]
          case 'canvas_draw_end':
            var q = n.drawPointBuffer
            if (!q.length) return [n]
            var K = n.backgroundCtx
            return K
              ? [
                  i(i({}, n), {}, { drawPointBuffer: [] }),
                  function () {
                    ;(K.lineWidth = 2 * S(n.canvasViewSize)), _(K, q)
                  },
                ]
              : [n]
          case 'home_carousel_tick':
            var Y = (function () {
              ...
              X = i(
                i({}, n),
                {},
                { homeColor: Y, shape: w(n.shapeDrawAreaSize) }
              ),
              G = n.foregroundCtx,
              Z = n.canvasViewSize
            return G
              ? [
                  X,
                  function () {
                    return x(G, Z, n.shape, n.homeColor, !1, !0)
                  },
                ]
              : [X]
          case 'game_tick':
      ...
      subscriptions: function (e) {
        return {
          windowSize: function () {
            ...
            return {
              effect: function (t) {
                ;(e = t), window.addEventListener('resize', n), n()
              },
              cancel: function () {
                  ...
                  return {
                    effect: function (n) {
                      e = setInterval(function () {
                        return n({ type: 'home_carousel_tick' })
                      }, 250)
                    },
                    cancel: function () {
                      clearInterval(e)
      ...
      view: function (e, n) {
        var t
        switch (((window.$model = e), e.page)) {
          case 'home':
            t = (0, g.jsx)('button', {
              className: 'nav-button',
              onClick: function () {
                return n({ type: 'start_game' })
              },
              children: 'Start',
            })
            break
        ...
        var r = Date.now() - e.gameStart,
          a = 'game' === e.page ? Math.max(0, (2e3 - r) / 2e3) : 1,
          l = { width: e.canvasSize.width, height: e.canvasSize.height },
          o = {
            width: e.canvasViewSize.width,
            height: e.canvasViewSize.height,
          },
          u = i(i({}, o), {}, { style: i({}, l) }),
          s = i(i({}, o), {}, { style: i({}, l) }),
          c = function () {
            return n({ type: 'canvas_draw_end' })
          }
        return (0, g.jsx)('div', {
          className: 'app',
          children: (0, g.jsxs)('div', {
            ...
            children: [
              (0, g.jsxs)('div', {
                ...
                style: {
                  opacity: a,
                  cursor: 'game' === e.page ? 'crosshair' : void 0,
                },
                onTouchMove:
                  'game' === e.page
                    ? function (e) {
                  ...
                  (0, g.jsx)(
                    ...
                    i(
                      ...
                      {},
                      {
                        ...
                        children:
                          "Your browser doesn't support the canvas API, which this game requires.",
                      }
                    ),
                    'foreground'
                  ),
                      ...
                      children: (0, g.jsxs)('div', {
                        ...
                        children: [
                          (0, g.jsxs)('div', {
                            className: 'stat',
                            children: [
                              (0, g.jsx)('label', { children: 'Colored' }),
                              (0, g.jsx)('b', {
                                children: (0, g.jsx)('button', {
                                  onClick: function (e) {
                                    e.preventDefault(),
                                      n({ type: 'open_score_explainer' })
                                  },
                                  children: e.score,
                                }),
                              }),
                          ...
                          (0, g.jsxs)('div', {
                            className: 'stat',
                            children: [
                              (0, g.jsx)('label', { children: 'Seconds' }),
                              (0, g.jsx)('b', {
                                children: Math.floor(e.gameLength / 1e3),
                              }),
                            ],
                          }),
                        ],
              ...
              (0, g.jsxs)('div', {
                ...
                children: [
                  (0, g.jsxs)('p', {
                    className: 'credit',
                    children: [
                      (0, g.jsx)('b', { children: 'Re:Turn' }),
                      (0, g.jsx)('br', {}),
                      ' by ',
                      (0, g.jsx)('a', {
                        href: 'https://jew.ski/',
                        children: 'Chris Andrejewski',
                      }),
                    ],
                  }),
                  t,
              ...
              e.scoreExplainerOpen &&
                (0, g.jsx)('div', {
                  className: 'modal-container',
                  children: (0, g.jsxs)('div', {
                    className: 'modal',
                    children: [
                      (0, g.jsx)('h3', { children: 'Scoring' }),
                      (0, g.jsxs)('p', {
                        children: [
                          'The "Colored" percentage is',
                          ' ',
                          (0, g.jsx)('b', {
                            children: 'pixels colored inside the lines',
                          }),
                          ' minus 5 times',
                          ' ',
                          (0, g.jsx)('b', {
                            children: 'the pixels colored outside the lines',
                          }),
                          ' divided by the',
                          ' ',
                          (0, g.jsx)('b', { children: 'shape area in pixels' }),
                          ' that could have been colored.',
                        ],
                      }),
                      (0, g.jsx)('table', {
                        className: 'stats',
                        children: (0, g.jsxs)('tbody', {
                          children: [
                            ...
                            (0, g.jsxs)('tr', {
                              children: [
                                (0, g.jsx)('th', {
                                  children: 'Pixels colored outside the lines',
                                }),
                                (0, g.jsx)('td', {
                                  children: e.pixelsOverfilled,
                                }),
                              ],
                            }),
                            (0, g.jsxs)('tr', {
                              children: [
                                (0, g.jsx)('th', {
                                  children: 'Pixels missed colored',
                                }),
                                (0, g.jsx)('td', {
                                  children: e.pixelsUnderFilled,
                                }),
                              ],
                            }),
                            (0, g.jsxs)('tr', {
                              children: [
                                (0, g.jsx)('th', {
                                  children: 'Shape area in pixels',
                                }),
                                (0, g.jsx)('td', {
                                  children:
                                    e.pixelsFilled + e.pixelsUnderFilled,
                                }),
                              ],
                            }),
                          ],
                      ...
                      (0, g.jsx)('button', {
                        className: 'nav-button',
                        onClick: function () {
                          return n({ type: 'dismiss_score_explainer' })
                        },
                        children: 'Dismiss',
                      }),
                    ],
    ...
    var O = t(970)
    var L,
      R = n.createRoot(document.getElementById('root')),
      D =
        ((L = function () {
          return E
        }),
        (function (e) {
          ...
          function l() {
            ...
            for (var n = arguments.length, t = new Array(n), r = 0; r < n; r++)
              t[r] = arguments[r]
            return (
              ((e = a.call.apply(a, [this].concat(t)))._view = void 0),
              (e._dispatch = void 0),
              (e._killProgram = void 0),
              e
            )
          }
          return (
            ...
            (t = [
              ...
              },
              {
                ...
                value: function () {
                  this._killProgram &&
                    (this._killProgram(), (this._killProgram = void 0))
                },
              },
              {
                key: 'render',
                value: function () {
                  return this._view && this._dispatch
    ...
    R.render((0, g.jsx)(e.StrictMode, { children: (0, g.jsx)(D, {}) }))
  })()
})()
//# sourceMappingURL=main.f76abd93.js.map
